...
from bigym.envs.reach_target import ReachTargetDual, ReachTarget, ReachTargetSingle
...
print("Initial target positions:")
for i, target in enumerate(env.unwrapped.targets):
    print(f"Target {i}: {target.body.get_position()}")
